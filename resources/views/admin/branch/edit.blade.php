...
@section('content')
    ...
    <form class="needs-validation" action="{{ route('branch.update') }}" method="post" novalidate enctype="multipart/form-data">
        @csrf
                    ...
                    <div class="card-body">
                        ...
                        {{-- <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="driving_license_number"
                                    value="{{ old('driving_license_number', optional($user->Company)->driving_license_number) }}">
                            </div>
                        </div> --}}
                        {{-- <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <div class="mb-3">
                                    ...
                                    <img class="img-thumbnail rounded me-2" id="blah4" alt="" width="200"
                                        src="{{ optional($user->Company)->getFirstMediaUrl('Company-license') }}"
                                        data-holder-rendered="true"
                                        style="display: {{ is_have_image(optional($user->Company)->getFirstMediaUrl('Company-license')) }};">

                                </div>
                                <div class="mb-0">
                                    <input class="form-control" name="Company_license_image" type="file"
                                        id="imgInp4">
                                </div>
                            </div>
                        </div> --}}
                                ...
                                <select class="form-control input-height" name="vehicle_type" required>
                                    ...
                                    @foreach ($vehicle_types as $item)
                                        ...
                                        <option value="{{ $item->id }}"
                                            @if (old('vehicle_type', optional($user->Company)->vehicle_type ?? '') == $item->id) selected @endif>
                                            {{ $item->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-9">
                                <select class="form-control input-height" name="vehicle_id" required>
                                    ...
                                    @foreach ($vehicles as $item)
                                        <option value="{{ $item->id }}"
                                            @if (old('vehicle_id', optional($user->Company)->vehicle_id) == $item->id) selected @endif>{{ $item->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="driving_exprience"
                                    value="{{ old('driving_exprience', optional($user->Company)->driving_exprience) }}">
                            </div>
                        </div> --}}
                        ...
                        <div class="row">
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="latitude" value="{{ old('latitude',$user->branch->latitude) }}" required>
                                </div>
                            </div>
                            <div class="form-group row mb-3">
                                <label class="col-md-3 col-form-label">Branch Longitude <span class="text-danger"></span></label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="longitude" value="{{ old('longitude',$user->branch->longitude) }}" required>
                                </div>
                            </div>
                        </div>
                    </div>
