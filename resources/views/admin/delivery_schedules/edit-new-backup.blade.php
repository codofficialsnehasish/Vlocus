    ...
    <div class="offcanvas offcanvas-start delivery-note-overlay" tabindex="-1" id="deliveryNote" aria-modal="true" role="dialog" style="width: 100%;">
        ...
        <div class="offcanvas-body" style="position: relative">
            <form id="task-form" >
                ...
                <div class="d-grid" style="position: absolute; bottom: 0; margin-bottom: 20px;width: 92%">
                    <button type="submit" class="btn btn-primary text-uppercase fw-bold">Add Delivery Task</button>
                </div>
            </form>
        </div>
    </div>
                ...
                <div class="p-3">
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-4">
                            <input type="text" id="delivery_date"  name="delivery_date" value="{{ old('delivery_date',$delivery_Schedule->delivery_date) }}" class="form-control" placeholder="DD/MM/YYYY">
                        </div>
                        <div class="custom-input-wrapper mb-3 col-md-4">
                            {{-- <label class="custom-floating-label">VEHICLE DETAILS</label>
                            <input type="text" class="form-control custom-input" placeholder="Vehicle Details"> --}}
                    ...
                    <div class="mb-4 mt-3">
                        <a href="javascript:void(0);" data-bs-toggle="offcanvas"  data-bs-target="#deliveryNote" class="btn-add text-decoration-none"><i class="bi bi-plus-circle me-1"></i> ADD DELIVERY NOTE</a>
                    </div>
                    <div class="mb-3" id="searchWrapper" style="display:none;">
                        {{-- <label class="form-label fw-bold">Search Shop</label> --}}
                        ...
                        <ul id="sortable-shop-location" class="list-group scrollable-list"></ul> --}}
                        {{-- <ul id="sortable-shop-location" id="searchShop" class="list-group scrollable-list"></ul> --}}
                    </div>
                    ...
                    <div id="locations">
                                    ...
                                    <div class="collapse" id="location{{ $loop->iteration }}">
                                        <div class="location-content">
                                            ...
                                            @foreach($item->products as $product)
                                                ...
                                                <input type="hidden" name="product_titles[{{ $loop->parent->index }}][]" value="{{ $product->title }}">
                                                <input type="hidden" name="product_qtys[{{ $loop->parent->index }}][]" value="{{ $product->qty }}">
                                                <input type="hidden" name="product_units[{{ $loop->parent->index }}][]" value="{{ $product->unit_or_box }}">
                                            @endforeach
                                        </div>
                                    </div>
                        ...
                        <!-- Location 2 -->
                        {{--<div class="d-flex w-100 align-items-start gap-3 mb-3">
                            <div class="bg-primary d-flex align-items-center justify-content-center rounded-circle flex-shrink-0"
                                style="width: 30px; height: 30px;">
                                <p class="text-white m-0 fw-bold">2</p>
                            </div>

                            <div class="location-box flex-grow-1 w-100">
                                <div class="location-header p-2 d-flex justify-content-between align-items-center"
                                data-bs-toggle="collapse" data-bs-target="#location2" style="cursor: pointer;">
                                <div><i class="bi bi-geo-alt-fill me-2 text-primary"></i>
                                    Location 2</div>
                                <div class="d-flex align-items-center gap-2">
                                    <i class="bi bi-chevron-down toggle-icon"></i>
                                    <button class="btn-icon p-0"><i class="bi bi-trash-fill"></i></button>
                        ...
                        <div class="d-flex w-100 align-items-start gap-3 mb-3">
                            <div class="bg-primary d-flex align-items-center justify-content-center rounded-circle flex-shrink-0"
                                style="width: 30px; height: 30px;">
                                <p class="text-white m-0 fw-bold">3</p>
                            </div>

                            <div class="location-box flex-grow-1 w-100">
                                <div class="location-header p-2 d-flex justify-content-between align-items-center"
                                data-bs-toggle="collapse" data-bs-target="#location3" style="cursor: pointer;">
                                <div><i class="bi bi-geo-alt-fill me-2 text-primary"></i>
                                    Location 3</div>
                                <div class="d-flex align-items-center gap-2">
                                    <i class="bi bi-chevron-down toggle-icon"></i>
                        ...
                        <div class="d-flex w-100 align-items-start gap-3 mb-3">
                            <div class="bg-primary d-flex align-items-center justify-content-center rounded-circle flex-shrink-0"
                                style="width: 30px; height: 30px;">
                                <p class="text-white m-0 fw-bold">4</p>
                            </div>

                            <div class="location-box flex-grow-1 w-100">
                                <div class="location-header p-2 d-flex justify-content-between align-items-center"
                                data-bs-toggle="collapse" data-bs-target="#location4" style="cursor: pointer;">
                                <div><i class="bi bi-geo-alt-fill me-2 text-primary"></i>
                                    Location 4</div>
                                <div class="d-flex align-items-center gap-2">
                                    <i class="bi bi-chevron-down toggle-icon"></i>
                    ...
                    <!-- <div class="mb-4 mt-3">
                        <a href="#" class="text-decoration-none"><i
                            class="bi bi-plus-circle me-1"></i> Add Shop</a>
                        </div> -->
                    ...
                    <div class="bottom-button-container">
                        {{-- <div class="mb-4 mt-3">
                        <a href="javascript:void(0);" data-bs-toggle="offcanvas"  data-bs-target="#deliveryNote" class="text-decoration-none"><i class="bi bi-plus-circle me-1"></i> Add Shop</a>
                        </div> --}}
                        <div class="d-flex justify-content-between">
                            <button class="btn btn-primary w-50 me-2" type="button" id="sortByNearestBtn">Routing</button>
...
@section('scripts')
    ...
    $(document).ready(function () {
        ...
        $("#task-form").on("submit", function (e) {
            ...
            // Get values by name/id
            let orderNo = $('input[name="invoice_no"]').val();
            let consignor = $("#search_shop_name").val();
            let consignee = $('input[name="consignee_details"]').val();
            ...
            <div class="d-flex w-100 align-items-start gap-3 mb-3 location-item" data-shop-id="${shop_id}">
                ...
                <div class="location-box flex-grow-1 w-100">
                    <div class="location-header p-2 d-flex justify-content-between align-items-center"
                        ...
                        <div class="d-flex align-items-center">
                            <i class="bi bi-geo-alt-fill me-2 text-primary"></i>
                            ${consignor || 'Location ' + locationCount}
                        </div>
                        <div class="d-flex align-items-center gap-2">
                            <i class="bi bi-chevron-down toggle-icon"></i>
                            <button type="button" class="btn-icon p-0 remove-location"><i class="bi bi-trash-fill"></i></button>
                    ...
                    <input type="hidden" name="invoice_no[]" value="${orderNo}">
                    ${productInputs}
