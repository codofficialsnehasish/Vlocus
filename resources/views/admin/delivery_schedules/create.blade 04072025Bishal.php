            ...
            <div class="col-md-12">
                <div class="deliveryScheduleDashboardRight">
                    <div class="bg-white">
                        <div class="row">
                            {{-- Map Container --}}
                            <div class=" col-lg-8" style="padding-right: 0; padding-left: 0; height:555px; position: relative; width:100%">
                                <div class="dashboardleft card" style="">
                                    ...
                                    <div id="shopMap" style="height: 690px;"></div>
                                </div>
                            ...
                            {{-- map form Container --}}
                            <div class=" col-lg-4" style="padding-left: 0; padding-right: 0; margin-top:90px; right: -200px; height:530px; right: 0; position: absolute">
                                <div class="card card-color" style="box-shadow: white 0px; margin-right:10px;">
    ...
    @endforeach-->
                            ...
                            <ul id="sortable-shops" class="list-group mt-2"></ul> --}}
                                            ...
                                            <div class="mb-3" style="height: 450px">
                                                ...
                                                <div id="suggestions"
                                                    class="list-group position-absolute z-index-3" style="z-index: 99999; height: 100px; overflow-y: auto; width: 95%;">
                                                </div>
                                                <div class="position-absolute bottom-0 end-0 start-0 p-3" style="margin-top: 15px; z-index: 0;">
                                                    <div
                                                        class="d-md-flex d-flex mb-lg-4 mb-sm-3 mb-4 d-grid justify-content-end align-items-center gap-2">
                                                        <button type="submit"
