        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="card card-color" style="height: 623px">
                    <div class="card-header text-center text-black" style="padding-bottom:20px;">Edit Delivery Schedule</div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <ul id="sortable-shop-location" class="list-group scrollable-list" style="height: 1800px">
                                    @foreach ($selectedShops as $index => $item)
                                        ...
                                        @if ($shop)
                                            <li class="list-group-item d-flex align-items-center"
                                                ...
                                                <button type="button"
                                                    class="btn btn-danger btn-sm ms-2 remove-shop"><i class="fa-solid fa-trash"></i></button>
