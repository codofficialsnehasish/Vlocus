        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="deliveryScheduleDashboardRight">
                    <div class="bg-white">
                        <div class="row">
                            <div class=" col-lg-8" style="padding-right: 0; padding-left: 0; height:555px;">
                                <div class="dashboardleft card" style="">
                                    ...
                                    <div id="shopMap" style="height: 490px;"></div>
                                </div>


                            </div>
                            <div class=" col-lg-4" style="padding-left: 0; padding-right: 0; height:555px;">
                                <div class="card card-color" style="box-shadow: white 0px">
    ...
    @endforeach-->
                            ...
                            <ul id="sortable-shops" class="list-group mt-2"></ul> --}}
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="search_shop_name"
                                                    placeholder="Enter shop name" style="margin-top: 15px;">
                                                <div id="suggestions"
