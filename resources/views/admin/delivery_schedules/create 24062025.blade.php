               ...
               <div class="deliveryScheduleDashboardRight">
                   <div class="bg-white">
                     ...
                     <div class="col-lg-6">
                         ...
                         <div class="card-header text-center text-black">Easy Task Creation to manage deliveries</div>
                    ...
                    <div class="card-header text-center text-black">Add Delivery Schedule</div>
                    <div class="card-body">
                        ...
                        <div class="row">
                               <div style="display: flex; gap:20px; width:470px">
                                                <div class="mb-3 col-md-12" style="width: 30%">
                                                    ...
                                                    <input style="font-size: 15px" type="date" class="form-control"
                                                        value="{{ old('delivery_date',date('Y-m-d')) }}" name="delivery_date"
                                                        id="delivery_date" placeholder="Enter date" required
                                                        >
                                                    ...
                                                    <select class="form-select single-select-field" name="driver_id"
                                                        ...
                                                        @foreach ($drivers as $driver)
                                                            <option value="{{ $driver->id }}"
                                                                ...
                                                                ({{ getDriverDetails($driver->id)->vehicle->vehicle_number }})
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    <div class="valid-feedback">Looks good!</div>
                                                ...
                                                <div class="mb-3 col-md-12" style="width: 30%">
                                                    ...
                                                    <select class="form-select " name="payment_type"
                                                        ...
                                                        <option value="Pre-Paid"
                                                            {{ old('payment_type') == 'Pre-Paid' ? 'selected' : '' }}>
                                                            Pre-Paid

                                                        </option>
                                                        <option value="Pre-Paid"
                                                            {{ old('payment_type') == 'COD' ? 'selected' : '' }}>COD
                                            ...
                                            <div class="mb-3 col-md-12" >
                                                <label class="form-label" for="delivery_date">Delivery Note <span
                                                        class="text-danger">*</span></label>
                                                <textarea name="delivery_note" id="delivery_note" class="form-control" >{{ old('delivery_note') }}</textarea>
                                                <div class="valid-feedback">Looks good!</div>
                            ...
                            <div class="mb-3">
                                     <label class="form-label">Add Shops</label>
                                                ...
                                                <input type="text" class="form-control" id="search_shop_name"
                                                    placeholder="Enter shop name">
                                                <div id="suggestions" class="list-group position-absolute w-100 z-index-3">
                                                </div>
                                <ul id="sortable-shop-location" class="list-group scrollable-list"
                                   ...
                                   <div
                                            class="position-absolute bottom-0 end-0 start-0 p-3  border-top">
                                            <div
                                                class="d-md-flex d-grid justify-content-end align-items-center gap-3">
                                                <button type="submit"
...
@section('scripts')
    ...
    <script
  src="https://maps.gomaps.pro/maps/api/js?key=AlzaSyC7RSr791vm_29LJiUOPJO-sLnBZg6qiGl&libraries=places&callback=initializeMap"
  async defer>
</script>
    ...
    function initializeMap() {
        ...
        function drawRouteToShop(shopLat, shopLng) {
        ...
        $(document).ready(function() {
            ...
            $suggestions.on('click', 'a', function(e) {
                ...
                if ($sortableList.find(`li[data-id="${data.id}"]`).length === 0) {
                    ...
                    <div class="handle text-secondary ms-auto" style="cursor: grab;">
                        <span class="sl-no"></span>  
                        <span class="ms-2 flex-grow-1">${data.name}</span>
                        ...
                        <button type="button" class="btn btn-danger btn-sm ms-2 remove-shop"><i class="fa-solid fa-trash"></i></button>
