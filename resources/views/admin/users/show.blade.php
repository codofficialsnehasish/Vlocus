        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <ul class="nav nav-tabs page-header-tab">
                    ...
                    <li class="nav-item"><a class="btn btn-info" href="{{ route('user.index') }}"><i class="fa fa-arrow-left me-2"></i>Back</a></li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-4">
                    <div class="card mb-4">
                        ...
                        <div class="card-body text-center">
                            {{-- <img src="{{ $user->getFirstMediaUrl('user-image') }}" alt="Profile Picture" class="profile-image mb-3" width="100"> --}}
                            <h6>{{ $user->name }}</h6>
