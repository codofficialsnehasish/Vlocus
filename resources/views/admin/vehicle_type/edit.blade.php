...
@section('content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            <div class="d-flex align-items-center gap-2 justify-content-lg-end">
                <a class="btn btn-primary px-4" href="{{ route('vehicle-type.index') }}"><i
    ...
    <form class="needs-validation" action="{{ route('vehicle-type.update') }}" method="post" novalidate
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                <img class="img-thumbnail rounded me-2" id="blah" alt="" width="200"
                                    src="{{ $data->getFirstMediaUrl('vehicle-type-icon') }}" data-holder-rendered="true" style="display: {{ is_have_image($data->getFirstMediaUrl('vehicle-type-icon')) }};">
