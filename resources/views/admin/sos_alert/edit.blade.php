...
@section('content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            <div class="d-flex align-items-center gap-2 justify-content-lg-end">
                <a class="btn btn-primary px-4" href="{{ route('brand.index') }}"><i
    ...
    <form class="needs-validation" action="{{ route('brand.update') }}" method="post" novalidate
        ...
        <div class="row">
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header text-center">Edit Brand Details</div>
                    <div class="card-body">
                        <div class="mb-3">
