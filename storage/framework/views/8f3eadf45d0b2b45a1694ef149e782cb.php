                                    ...
                                    <div class="collapse" id="location<?php echo e($loop->iteration); ?>">
                                        <div class="location-content">
                                            ...
                                            <?php $__currentLoopData = $item->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <input type="hidden" name="product_titles[<?php echo e($loop->parent->index); ?>][]" value="<?php echo e($product->title); ?>">
                                                <input type="hidden" name="product_qtys[<?php echo e($loop->parent->index); ?>][]" value="<?php echo e($product->qty); ?>">
                                                <input type="hidden" name="product_units[<?php echo e($loop->parent->index); ?>][]" value="<?php echo e($product->unit_or_box); ?>">
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\vlocus\resources\views/admin/delivery_schedules/edit.blade.php ENDPATH**/ ?>