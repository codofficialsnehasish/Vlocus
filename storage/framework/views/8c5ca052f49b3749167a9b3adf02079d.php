...
@media (max-width: 991px) {
  ...
  #shopMap {
    height: 60vh; /* Reduce map height to make room for form */
  }
  
  .scrollable-list {
    height: auto !important; /* Remove fixed height */
    max-height: 300px; /* Add scroll if needed */
  }
}
...
@media (max-width: 767px) {
  #right-card-body {
    height: auto !important; /* Make form card height flexible */
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            <div class="d-flex align-items-center gap-2 justify-content-lg-end">
                <a class="btn btn-primary px-4" href="<?php echo e(route('delivery-schedule.index')); ?>">
    ...
    <form class="needs-validation" action="<?php echo e(route('delivery-schedule.update', $delivery_Schedule->id)); ?>" method="post"
                    ...
                    <div class="bg-white">
                        <div class="row">
                            ...
                            <div class="col-lg-12" style="">
                                <div class="dashboardleft card" style="margin-bottom: 0px;">
                                    
                                    
                                    
                                    <div id="shopMap" class="" style="height: 80vh; padding-top: 10px; position: relative; width:auto"></div>
                                </div>
                            </div>
                            
                            
                            <div class="col-lg-4 col-md-6 col-12" id="right-card-main-body">
                                <div class="card card-color" style="height: 623px" id="right-card-body">
                                    <div class="card-header text-center text-black" style="padding-bottom:20px; padding-top: 20px;">Edit
                                        Delivery Schedule</div>
                                    <div class="card-body" id="right-card-body">

                                        <div class="row">


                                            <div class="mb-6" style="display: flex; gap:20px; width:470px; padding-right: 25px;">
                                                <div class="mb-3 col-md-12 col-6" style="width: 40%">
                                                ...
                                                <div class="mb-3 col-md-12 col-6" style="width:60%">
                                            ...
                                            <!--                <?php echo e(old('payment_type', $delivery_Schedule->payment_type) == 'Pre-Paid' ? 'selected' : ''); ?>>-->
                                            <!--                Pre-Paid-->

                                            <!--            </option>-->
                                            <!--            <option value="Pre-Paid"-->
                                            <!--                <?php echo e(old('payment_type', $delivery_Schedule->payment_type) == 'COD' ? 'selected' : ''); ?>>COD-->
                                            ...
                                            <!--        value="<?php echo e(old('amount', $delivery_Schedule->amount)); ?>"-->
                                            ...
                                            <!--            class="text-danger">*</span></label>-->
                                            <!--    <textarea name="delivery_note" id="delivery_note" class="form-control"><?php echo e(old('delivery_note', $delivery_Schedule->delivery_note)); ?></textarea>-->
                                            <!--    <div class="valid-feedback">Looks good!</div>-->
                                            ...
                                            <div class="mb-6">
                                                ...
                                                <input type="text" class="form-control" id="search_shop_name"
                                                    placeholder="Enter shop name" style="margin-top: 10px;">
                                                <div id="suggestions"
                                                            ...
                                                            <li class="list-group-item d-flex flex-column"
                                                                ...
                                                                <div class="handle" style="cursor: grab;">
                                                                    <div
                                                                        ...
                                                                        <div>
                                                                            <span
                                                                                class="sl-no"><?php echo e($loop->iteration); ?>.</span>
                                                                            <span
                                                                                class="ms-2 flex-grow-1"><?php echo e($shop->shop_name); ?>

                                                                                L.R / Challan No - <?php echo e($item->lr_no); ?></span>
                                                                        </div>

                                                                        <div class="handle text-secondary"
                                                                            style="cursor: grab; display: flex; gap:4px;">
                                                                               <button type="button"
                                                                    ...
                                                                    <input type="hidden" name="shop_addresses[]"
                                                                        value="<?php echo e($shop->shop_address); ?>">
                                                                    <input type="hidden" name="shop_latitudes[]"
                                                                        value="<?php echo e($shop->shop_latitude); ?>">
                                                                    <input type="hidden" name="shop_longitudes[]"
                                                                        value="<?php echo e($shop->shop_longitude); ?>">
                                                                    ...
                                                                    <div class="shop-details mt-3" style="display: none;">
                                                                        ...
                                                                        <div class="d-flex gap-3 mb-2">
                                                                            <div style="width: 33%;">
                                                                                <input type="text" class="form-control"
                                                                                    name="invoice_no[]"
                                                                                    id="invoice_no_<?php echo e($shop->id); ?>"
                                                                            ...
                                                                            <div style="width: 33%;">
                                                                                <select class="form-select"
                                                                                    name="payment_types[]"
                                                                                    id="payment_type_<?php echo e($shop->id); ?>"
                                                                                    required>
                                                                                    <option value="" disabled
                                                                                        <?php echo e($item->payment_type == null ? 'selected' : ''); ?>>
                                                                                        Select Type</option>
                                                                                    <option value="Pre-Paid"
                                                                                        <?php echo e($item->payment_type == 'Pre-Paid' ? 'selected' : ''); ?>>
                                                                                        Pre-Paid</option>
                                                                                    <option value="COD"
                                                                                        <?php echo e($item->payment_type == 'COD' ? 'selected' : ''); ?>>
                                                                                        COD</option>
                                                                                </select>
                                                                            </div>
                                                                        ...
                                                                        <div class="mb-3">
                                                                            <textarea class="form-control" name="delivery_notes[]" id="delivery_note_<?php echo e($shop->id); ?>" rows="2"
                                                                                required><?php echo e($item->delivery_note); ?></textarea>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </li>
