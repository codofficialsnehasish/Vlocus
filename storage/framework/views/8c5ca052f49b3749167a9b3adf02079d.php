...
<?php $__env->startSection('content'); ?>
    ...
    <form class="needs-validation" action="<?php echo e(route('delivery-schedule.update', $delivery_Schedule->id)); ?>" method="post" novalidate enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
                ...
                <div class="p-3">
                    <div class="row p-1">
                        <div class="mb-3 col-md-3 p-0 edit-task-selector">
                            <input type="text" id="delivery_date"  name="delivery_date" value="<?php echo e(old('delivery_date',fromDbDate($delivery_Schedule->delivery_date))); ?>" class="form-control" placeholder="DD/MM/YYYY">
                            ...
                            <select class="form-select single-select-field" name="vehicle_id" id="vehicle_id" required>
                                ...
                                <?php $__currentLoopData = $vehicles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($vehicle->id); ?>"
                                        <?php echo e(old('vehicle_id',$delivery_Schedule->vehicle_id) == $vehicle->id ? 'selected' : ''); ?>>
                            ...
                            <select class="form-select single-select-field" name="driver_id" id="driver_id" required>
                                ...
                                <?php $__currentLoopData = $drivers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $driver): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($driver->id); ?>"
                                        <?php echo e(old('driver_id',$delivery_Schedule->driver_id) == $driver->id ? 'selected' : ''); ?>>
                    ...
                    <div id="locations">
                        ...
                        <?php $__currentLoopData = $selectedShops; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $shop = $item->shop;
                            ?>
                            ...
                            <div class="d-flex w-100 align-items-start gap-3 mb-3 location-item" data-shop-id="<?php echo e($shop->id); ?>">
                                <!-- Step Circle -->
                                <div class="bg-primary d-flex align-items-center justify-content-center rounded-circle flex-shrink-0"
                                    style="width: 30px; height: 30px;">
                                    <p class="text-white m-0 fw-bold"><?php echo e($loop->iteration); ?></p>
                                </div>

                                <!-- Location Box -->
                                <div class="location-box flex-grow-1 w-100">
                                    <div class="location-header p-2 d-flex justify-content-between align-items-center" data-bs-toggle="collapse" data-bs-target="#location<?php echo e($loop->iteration); ?>" style="cursor: pointer;">
                                    ...
                                    <input type="hidden" name="shop_ids[]" value="<?php echo e($shop->id); ?>">
                                    <input type="hidden" name="shop_names[]" value="<?php echo e($shop->shop_name); ?>">
                                    <input type="hidden" name="shop_addresses[]" value="<?php echo e($shop->shop_address); ?>">
                                    <input type="hidden" name="shop_latitudes[]" value="<?php echo e($shop->shop_latitude); ?>">
                                    <input type="hidden" name="shop_longitudes[]" value="<?php echo e($shop->shop_longitude); ?>">
                                    <input type="hidden" name="branch_id[]" value="<?php echo e(auth()->user()->employee?->branch?->id ?? ''); ?>">

                                    <div class="collapse" id="location<?php echo e($loop->iteration); ?>">
                                        <div class="location-content">
                                            <div class="row g-2 mb-2">
                                                <div class="col-md-4">
                                                    <input type="text" name="invoice_nos[]" class="form-control"
                                                        value="<?php echo e($item->invoice_no); ?>" placeholder="Enter Invoice">
                                                </div>
                                                <div class="col-md-4">
                                                    <select name="payment_types[]" class="form-select">
                                                        <option value="Pre-Paid" <?php echo e($item->payment_type == 'Pre-Paid' ? 'selected' : ''); ?>>Pre-Paid</option>
                                                        <option value="COD" <?php echo e($item->payment_type == 'COD' ? 'selected' : ''); ?>>COD</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-4">
                                                    <input type="number" name="amounts[]" class="form-control"
                                                        value="<?php echo e($item->amount); ?>" placeholder="0.0">
                                                </div>
                                            </div>
                                            ...
                                            <?php $__currentLoopData = $item->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="item-row">
                                                    <?php echo e($product->title); ?> - <?php echo e($product->qty); ?> <?php echo e(ucfirst($product->unit_or_box)); ?>

                                                    
                                                </div>

                                                <!-- hidden inputs for backend -->
                                                <input type="hidden" name="product_titles[<?php echo e($loop->parent->index+1); ?>][]" value="<?php echo e($product->title); ?>">
                                                <input type="hidden" name="product_qtys[<?php echo e($loop->parent->index+1); ?>][]" value="<?php echo e($product->qty); ?>">
                                                <input type="hidden" name="product_units[<?php echo e($loop->parent->index+1); ?>][]" value="<?php echo e($product->unit_or_box); ?>">
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                    </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        ...
        <?php $__currentLoopData = $selectedShops; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        selectedShops.push({
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u697667486/domains/delivery.flexcellents.com/public_html/resources/views/admin/delivery_schedules/edit.blade.php ENDPATH**/ ?>