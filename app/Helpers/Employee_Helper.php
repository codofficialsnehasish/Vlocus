<?php
    ...
    if (!function_exists('check_verified')){
        function check_verified($status){
            if($status == 1){
                $str = '<span class="text-success" title="Verified"><i class="material-icons-outlined" style="color:green;">check_circle</i></span></p>';
            }else{
                $str = '<span class="text-danger" title="Not Verified"><i class="material-icons-outlined" style="color:red;">highlight_off</i></span></p>';
            }
            return $str;
        }
    }
